...
class Contact extends Component {
    ...
    handleSubmit(event) {
        ...
        event.preventDefault();  //prevents page from refreshing after form submission (which happens by default)
    }
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type="text" id="firstName" name="firstName"
                                        ...
                                        invalid={errors.firstName}  // true if errors are there, false if errors is an empty string (no error)
